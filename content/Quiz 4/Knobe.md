...
- University metaphor, the brain has different departments for different topics but they all use scientific techniques
...
- He then examines another theory of competency
	- We generally consider the way things happen by considering the ways *other* things happen, so with a dented car example, why do we originally assume that the car was previously not dented instead of say, floating in the air? Well of course of things like controllability, recency, and badness
	- There is also evidence that our intuitions can be influenced by our moral judgements
		- In the chairman case, participants don't consider him to have intentionally helped the environment cause of the judgement of his moral character
- Knobe makes a model of how competency works like this
	- Far left is *con* and far right is *pro* and then the default is changed based on the moral judgement, so the scale can be relative to any scenario
	- This theory makes it so moral judgements are not some other factor in cognition and it is baked into the whole process, which seems to be true based on modern research such as System 1, System 2, Haidt stuff yeah yeah