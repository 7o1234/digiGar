In my opinion, Green's Theorem is when Calculus 3 really starts to be a different math class than 1 and 2. For a majority it's all just the derivative but twice now?! The integral but thrice now?! And I understand it is all necessary to build these higher level ideas but it just lacks depth I hope for in a class like Calculus 3, which is why I am excited to learn about Green's Theorem. 

---
Ok so maybe I do not know how Green made the formula but its basically this.

${\displaystyle \oint_C P\,dx + Q\,dy} = {\displaystyle \iint_D (\frac{\partial Q}{\partial x} - \frac{\partial P}{\partial y})\,dA}$
...
---
This is the example my professor showed us about the application of Green's Theorem.
The formula for an ellipse is as follows $\displaystyle \frac{x^2}{a^2}\,+\,\frac{y^2}{b^2} =1$ 
